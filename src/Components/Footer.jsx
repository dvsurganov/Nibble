            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between mb-8">
                    ...
                    <div className="md:w-1/3 mb-8 md:mb-0">
                        <h3 className="text-xl font-bold mb-4">Try AI Chef Now</h3>
                        <p className="text-gray-300 mb-4">
                            Let our AI create personalized recipes just for you. Generate recipes based on ingredients,
                            dietary requirements, and cooking time.
                        </p>
                        <button className="bg-purple-600 text-white font-medium py-3 px-6 rounded-lg hover:bg-purple-700 transition duration-150">
                            Get Started
                        </button>
                    </div>
